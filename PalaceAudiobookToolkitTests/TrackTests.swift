...
class TrackTests: XCTestCase {
    func testTrackEquality() {
        let track1 = Track(type: .href("http://example.com/track1.mp3"), title: "Track 1", duration: 300, index: 1)
        let track2 = Track(type: .href("http://example.com/track1.mp3"), title: "Track 1", duration: 300, index: 1)
    ...
    func testTrackInequalityByIndex() {
        let track1 = Track(type: .href("http://example.com/track1.mp3"), title: "Track 1", duration: 300, index: 1)
        let track2 = Track(type: .href("http://example.com/track2.mp3"), title: "Track 2", duration: 200, index: 2)
